        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fa fa-user me-2 mr-2"></i>Profile Information</h5>
                </div>
                <div class="card-body">
                    @if(session('success'))
                    ...
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <button class="btn btn-primary"><i class="fa fa-save me-1 mr-2"></i>Save</button>
                    </form>
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header bg-dark text-white">
                    <h5 class="mb-0"><i class="fa fa-lock me-2 mr-2"></i>Change Password</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.password') }}">
                        ...
                        <button class="btn btn-dark"><i class="fa fa-key me-1 mr-2"></i>Update Password</button>
                    </form>
                </div>
            </div>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-danger text-white">
                    <h5 class="mb-0"><i class="fa fa-trash me-2 mr-2"></i>Delete Account</h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.destroy') }}">
                        ...
                        <button class="btn btn-danger"><i class="fa fa-trash me-1 mr-2"></i>Delete Account</button>
                    </form>
                </div>
            </div>
