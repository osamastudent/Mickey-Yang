...
<div class="container-fluid mt-4">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            <h3 class="mb-0"><i class="fas fa-user-edit me-2"></i>Edit User</h3>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="activity_level" class="form-select form-control">
                            ...
                            <option value="Highly active" {{ old('activity_level', $user->activity_level) == 'Highly active' ? 'selected' : '' }}>Highly active</option>
                        </select>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Sleep Goals</label>
                        <input type="text" name="sleep_goals" class="form-control" value="{{ old('sleep_goals', $user->sleep_goals) }}">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Wake Up Time</label>
                        <input type="time" name="wake_up_time" class="form-control" value="{{ old('wake_up_time', $user->wake_up_time) }}">
                    </div>
                </div>
